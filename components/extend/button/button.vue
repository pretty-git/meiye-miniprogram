<template>
	<button class="tui-btn-class tui-btn" :class="[plain?'tui-'+type+'-outline':'tui-btn-'+(type || 'primary'),getDisabledClass(disabled,type),
	getShapeClass(shape,plain),getShadowClass(type,shadow,plain)]"
...
<style>
	button {
		color: #fff !important;
		background-color: #5D76E4 !important;
	}
	.tui-btn-primary {
